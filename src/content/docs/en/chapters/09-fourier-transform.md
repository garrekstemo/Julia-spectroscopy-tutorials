...
8. Using a single exponential decay function, fit the data to extract the energy relaxation time (use `NonlinearCurveFitProblem` and `solve` from Chapter 8). Plot the data and the fit.
